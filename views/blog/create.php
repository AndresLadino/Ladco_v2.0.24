...
m-22 -116 c-9 -9 -15 -9 -24 0 -9 9 -7 12 12 12 19 0 21 -3 12 -12z" />
        ...
        <div class="mt-12 pt-12 sm:ml-64">
            ...
            <div class="relative bg-white">
                ...
                <div class="p-6 space-y-6">
                    <div id="alert"></div>
                    <form action="funciones.php" method="POST" enctype="multipart/form-data" onsubmit="return validarFormulario()">
                        ...
                        <div class="grid grid-cols-6 gap-6 overflow-y-auto">
                            ...
                            <div class="col-span-6 sm:col-span-6">
                                ...
                                <input type="text" name="titulo" value="" id="titulo" class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="Título de la publicación">
                            </div>
                            <div class="col-span-6 sm:col-span-6">
                                <label for="parrafoPrincipal" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Párrafo
                                    principal</label>
                                <textarea id="parrafoPrincipal" name="parrafoPrincipal" rows="4" class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-primary-500 focus:border-primary-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="Escriba acá el primer párrafo"></textarea>
                            </div>
                            <div class="col-span-6 sm:col-span-6">
                                <label for="parrafoSecundario" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Párrafo
                                    secundario</label>
                                <textarea id="parrafoSecundario" name="parrafoSecundario" rows="4" class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-primary-500 focus:border-primary-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="Escriba acá el segundo párrafo"></textarea>
                            </div>
                            <div class="col-span-2 sm:col-span-2">
                                <label for="email" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Imágen de
                                    fondo
                                </label>
                                <input class="block w-full text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400" type="file" accept="image/*" name="imagenFondo" id="imgInp">
                            ...
                            <div class="col-span-2 sm:col-span-2">
                                ...
                                <input class="block w-full text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400" type="file" accept="image/*" name="imagenPrincipal" id="imgInp2">
                                <div class="mt-1 text-sm text-gray-500 dark:text-gray-300" id="user_avatar_help">Será la
                            ...
                            <div class="col-span-2 sm:col-span-2">
                                ...
                                <input class="block w-full text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400" type="file" accept="image/*" name="imagenSecundaria" id="imgInp3">
                                <div class="mt-1 text-sm text-gray-500 dark:text-gray-300" id="user_avatar_help">Será la
    ...
    <script>
        function validarFormulario() {
            ...
            var parrafoPrincipal = document.getElementById('parrafoPrincipal').value;
            var parrafoSecundario = document.getElementById('parrafoSecundario').value;
            var inputFondo = document.getElementById('imgInp');
            var inputPrincipal = document.getElementById('imgInp2');
            var inputSecundaria = document.getElementById('imgInp3');

            // Verificar si el campo 'titulo' está vacío
            if (titulo.trim() === "") {
                mostrarAlerta("Hace falta llenar el campo 'Título'.");
                return false;
            }

            // Verificar si el campo 'parrafoPrincipal' está vacío
            if (parrafoPrincipal.trim() === "") {
                mostrarAlerta("Hace falta llenar el campo 'Párrafo principal'.");
                return false;
            }

            if (parrafoSecundario.trim() === "") {
                mostrarAlerta("Hace falta llenar el campo 'Párrafo secundario'.");
                return false;
            }

            // Realizar la validación de campos de tipo file
            if (!contieneImagen(inputFondo) || !contieneImagen(inputPrincipal) || !contieneImagen(inputSecundaria)) {
                var mensajes = [];
                if (!contieneImagen(inputFondo)) {
                    mensajes.push("Selecciona una imagen para 'Imagen de fondo'.");
                }
                if (!contieneImagen(inputPrincipal)) {
                    mensajes.push("Selecciona una imagen para 'Imagen principal de la publicación'.");
                }
                if (!contieneImagen(inputSecundaria)) {
                    mensajes.push("Selecciona una imagen para 'Imagen secundaria de la publicación'.");
                }
                mostrarAlerta(mensajes.join('<br>'));
                return false;
            }
        ...
        function contieneImagen(input) {
            // Verificar si el input contiene algún archivo y si ese archivo es de tipo imagen
        ...
        function mostrarAlerta(mensaje) {
            ...
            alerta.innerHTML = '<div class="flex bg-red-50 border border-red-500 text-red-900 p-3"><div class="py-1"></div><div><p class="font-bold">¡Hey! Faltan campos obligatorios</p><p class="text-sm">' + mensaje + '</p></div></div>';
