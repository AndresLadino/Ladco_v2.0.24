    ...
    <main>
        <div class="mt-12 pt-12 sm:ml-64">
            ...
            <div id="FullImageView" class="flex items-center justify-center">
                ...
                <span id="CloseButton" onclick="CloseFullView()"><svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                ...
                <div class="w-full mb-1">
                    <div class="mb-4">
                        <h1 class="mb-4 text-4xl font-extrabold leading-none tracking-tight text-gray-900 md:text-5xl lg:text-6xl dark:text-white">
                            <span class="underline underline-offset-3 decoration-8 decoration-amber-400 dark:decoration-blue-600">Gestionar
            ...
            <div class="flex flex-col">
                        ...
                        <div class="overflow-hidden shadow">
                            ...
                            if ($resultado) {
                                ...
                                if ($resultado->num_rows > 0) {
                                    ...
                                    echo '<table class="min-w-full divide-y divide-gray-200 table-fixed dark:divide-gray-600" id="posts">
                <thead class="bg-gray-100 dark:bg-gray-700">
                    <tr>
                        <th scope="col" class="p-4 text-xs font-medium text-left text-gray-500 uppercase dark:text-gray-400" hidden>
                            ID
                        </th>
                        ...
                        <th scope="col" class="p-6 text-xs font-medium text-left text-gray-500 uppercase dark:text-gray-400">
                            Imágen de fondo
                        </th>
                        <th scope="col" class="p-4 text-xs font-medium text-left text-gray-500 uppercase dark:text-gray-400">
                ...
                <tr class="hover:bg-gray-100 dark:hover:bg-gray-700">
                    ...
                    <td class="text-base pl-4 whitespace-normal font-semibold text-gray-900 dark:text-white w-80">
                        ' . $publicacion['titulo'] . '
                    </td>
                    <td class="text-sm font-normal whitespace-normal text-gray-900 w-80">
            ' . limitarCaracteres($publicacion['parrafoPrincipal'], 90) . '
        </td>
                    <td class="p-4 text-sm font-normal text-gray-900 whitespace-normal w-80">
                        ' . limitarCaracteres($publicacion['parrafoSecundario'], 90) . '
                    </td>
                    <td class="p-4 text-base font-medium text-gray-900  dark:text-white"><img
                            src="' . $publicacion['imagenFondo'] . '" onclick="FullView(this.src)"
                    ...
                    <td class="p-4 text-base font-normal text-gray-900  dark:text-white"><img
                            src="' . $publicacion['imagenSecundaria'] . '"
                            onclick="FullView(this.src)"
                            class="w-20 hover:scale-150 transition duration-500 cursor-pointer m-auto" />
                    </td>
                    <td class="p-4 space-x-2 whitespace-nowrap">
                        ...
                        <div id="dropdown-' . $i . '"
                            ...
                            aria-labelledby="dropdownDefaultButton-' . $i . '">
                                <li>
                                <a href="edit.php?id=' . $publicacion['id'] . '">
                                        <button
                                ...
                                <li>
                                    <button data-post-id="' . $publicacion['id'] . '" data-modal-toggle="delete-post-modal"
                                        class="delete-button relative inline-flex items-center justify-center w-full  overflow-hidden text-sm font-medium text-gray-900  group bg-gradient-to-br from-pink-500 to-orange-400 group-hover:from-pink-500 group-hover:to-orange-400 hover:text-white  dark:focus:ring-red-400"
                                        type="button">
                                        <span
                                            class="relative flex items-center px-5 w-full py-2.5 transition-all ease-in duration-75 bg-white dark:bg-gray-900  group-hover:bg-opacity-0">
                                            <svg class="w-4 h-4 mr-2" fill="currentColor"
                                ...
                                <li>
                                    <a target="_blank" href="../leer_noticia.php?titulo='. urlencode($publicacion['titulo']) .'">
                                        <button
                                    ...
                                    // Si no hay filas en el resultado, muestra un mensaje de que no hay datos
                                ...
                                // Libera el resultado después de usarlo
                                $resultado->free();
                            } else {
                                // Si la consulta no se ejecuta correctamente, muestra un mensaje de error
                                echo '<p>Error en la consulta: ' . $conexion_instancia->getConexion()->error . '</p>';
                            }
            ...
            <!-- Delete User Modal -->
            <div class="fixed left-0 right-0 z-50 items-center justify-center hidden overflow-x-hidden overflow-y-auto top-4 md:inset-0 h-modal sm:h-full" id="delete-post-modal">
                <div class="relative w-full h-full max-w-md px-4 md:h-auto">
                    <!-- Modal content -->
                    <div class="relative bg-white rounded-lg shadow dark:bg-gray-800">
                        <!-- Modal header -->
                        <div class="flex justify-end p-2">
                            <button type="button" class="text-gray-400 bg-transparent hover:bg-slate-800 hover:text-white rounded-lg text-sm p-1.5 ml-auto inline-flex items-center dark:hover:bg-gray-700 dark:hover:text-white" data-modal-toggle="delete-post-modal">
                        ...
                        <div class="p-6 pt-0 text-center">
                            ...
                            <form id="delete-post-form" action="funciones.php" method="POST">
                                <input type="hidden" name="accion" value="eliminar">
                                <input type="hidden" id="delete-post-id" name="id" value="">
